...
CAMINHO_SQLITE_DEV = os.getenv("CAMINHO_SQLITE_DEV", "")
...
DIRETORIO_BASE_CONTESTACAO = Path(os.getenv("DIRETORIO_BASE_CONTESTACAO", ""))

CABECARIO_PLANILHA = [
    col.strip() for col in os.getenv("CABECARIO_PLANILHA", "").split(";") if col.strip()
]
