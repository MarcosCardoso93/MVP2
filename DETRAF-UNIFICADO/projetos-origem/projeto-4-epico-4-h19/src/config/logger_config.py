...
class LoggerWrapper:
    ...
    def info(self, message):
        self._logger.opt(depth=2).info(message)

    def debug(self, message):
        self._logger.opt(depth=2).debug(message)

    def warning(self, message):
        self._logger.opt(depth=2).warning(message)

    def error(self, message):
        self._logger.opt(depth=1).error(message)

    def critical(self, message):
        self._logger.opt(depth=2).critical(message)
